...
import { TenantReadOnlyBanner } from "@/components/layout/tenant-read-only-banner";
  ...
  return (
    ...
    >
      ...
      <SidebarInset>
        ...
        <main className="flex-1 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] @container md:p-6">{children}</main>
      </SidebarInset>
    </SidebarProvider>
  );
}
