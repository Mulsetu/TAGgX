...
function CreateCategoryDialog({ categories }: { categories: CategorySummary[] }) {
    ...
    >
      ...
      <DialogContent>
        ...
        <form action={handleSubmit} className="flex flex-col gap-4">
          <CategoryFormFields otherCategories={categories} />
          {state.error ? (
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <form action={handleSave} className="flex flex-col gap-4">
          <CategoryFormFields category={category} otherCategories={categories} />
          {state.error ? (
            <p role="alert" className="text-sm text-destructive">
              {state.error}
            </p>
...
export function CategoryList({ categories }: { categories: CategorySummary[] }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <EditCategoryDialog category={selected} categories={categories} open={open} onOpenChange={setOpen} />
    </div>
  );
}
